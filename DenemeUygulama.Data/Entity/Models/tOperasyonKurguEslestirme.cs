...
{
    public class tOperasyonKurguEslestirme : BaseClass
    {
    ...
    public class tOperasyonKurguEslestirme_Map : EntityTypeConfiguration<tOperasyonKurguEslestirme>
    {
        public tOperasyonKurguEslestirme_Map()
        {
            HasKey(k => k.Id);
            ToTable("tOperasyonKurguEslestirme");
